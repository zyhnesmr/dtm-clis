...
func SagaBarrier() {
	...
	saga := dtmgrpc.NewSagaGrpc(dtmSvc, gid).
		Add("k8s://ohmyfans/dtm-rpc-svc:9091/busis.Busis/AddMoney", "k8s://ohmyfans/dtm-rpc-svc:9091/busis.Busis/DelMoney", addReq).
		Add("k8s://ohmyfans/dtm-rpc-svc:9091/busis.Busis/DelMoney", "k8s://ohmyfans/dtm-rpc-svc:9091/busis.Busis/AddMoney", delReq)
